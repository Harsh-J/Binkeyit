...
const ProductCardAdmin = ({ data, fetchProductData }) => {
  ...
  return (
    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-36 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden flex flex-col justify-between">
      <div>
        <img
          src={data?.image[0]}
          alt={data?.name}
